...
$house = get_post_meta($post->ID,'house_dados',true);
$textoPrincipal = get_post_meta($post->ID,'house_textoPrincipal',true);
...
$imagemDestaque = get_relative_thumb($house["imagemDestaque"],'large');
wp_reset_query();
?>
...
<main>
	...
	<?php
	if(isset($house["fotosVideos"]) && is_array($house["fotosVideos"])) {
		?>
				...
				<div class="row">
					<div class="col-12">
						<div class="owl-carousel gallery owl-theme" id="destino_sliderFotosVideos">
							<?php
							foreach($house["fotosVideos"] as $mediaItem) {
								?>
								<div class="item">
									<?php
		...
		<div class="container-fluid">
			<div class="row">
				<div class="col-12 col-lg-12">
					<div class="row">
						<iframe src="https://www.google.com/maps?q=<?php echo $house["endereco"]." ".$cidade." ".$pais; ?>&output=embed" width="100%" height="503" frameborder="0" style="border:0" allowfullscreen></iframe>
					</div>
				</div>
			</div>
		</div>
