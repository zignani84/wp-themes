				...
				<div class="row">
					<nav aria-label="breadcrumb">
						<ol class="breadcrumb">
							...
							<li class="breadcrumb-item"><?php _e('Destinos','egali'); ?></li>
						</ol>
					</nav>
				</div>
			</div>
								...
								<div class="col-12 col-lg-4">
									<div class="card">
										...
										<div class="card-body" style="box-shadow: 0px 20px 40px rgba(0, 0, 0, 0.1);">
											...
											<a class="btn-secondary" style="display:block" href="<?php echo $pais["link"];?>"><?php _e('Saiba Mais','egali'); ?></a>
										</div>
									</div>
								</div>
								<?php
