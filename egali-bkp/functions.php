...
function egali_enqueue_styles() {
	...
	if (is_page( ['destinos-interna', 'intercambio', 'intercambio-interna'] )) {
		wp_enqueue_style('egali-lightbox-min-styles', get_template_directory_uri().'/css/lightbox.min.css');
		wp_enqueue_script( 'jquery' );
		wp_enqueue_script( 'egali-carousel-script', get_theme_file_uri().'/js/owl.carousel.js');
		wp_enqueue_script( 'egali-lightbox-min-script', get_theme_file_uri().'/js/lightbox.min.js' );
		wp_enqueue_script( 'egali-easing-script', get_theme_file_uri().'/js/jquery.easing.1.3.js'  );
	}
}
...
/*function remove_head_scripts() { 
   ...
   //remove_action('wp_head', 'enqueue_scripts', 1);
 
   //add_action('wp_footer', 'wp_print_scripts', 5);
   //add_action('wp_footer', 'enqueue_scripts', 5);
