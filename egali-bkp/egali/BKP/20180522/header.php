									...
									<li class="nav-item dropdown">
										...
										<div class="dropdown-menu" aria-labelledby="navbarDropdown">
											<div class="masonry">
												...
												<div class="item">
													<a class="nav-link active" href="<?php echo get_site_url();?>/destino/">Todos os Destinos</a>
												</div>
										...
										<div class="dropdown-menu" aria-labelledby="navbarDropdown">
											<div class="container">
												<div class="row">
													...
													<div class="col-md-3">
														<ul class="nav flex-column">
															<li class="nav-item"><a class="nav-link active" href="<?php echo get_site_url();?>/intercambio/">Todos os Intercâmbios</a></li>
														</ul>
													</div>
