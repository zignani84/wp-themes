...
<main>
		...
		<div class="container">
			...
			<div class="row">
				<div class="col-12 col-sm-3 col-lg-3">
					<img src="<?php echo get_theme_file_uri(); ?>/img/img-sobre-cidade.png" class="w-100 img-fluid" alt="Sobre a Cidade" title="Montreal" />
				</div>
			...
			<div class="row">
				<div class="col-12">
					<div class="owl-carousel gallery owl-theme" id="gallery">
						<div class="item">
							<a href="<?php echo get_theme_file_uri(); ?>/img/montreal-01.png" data-lightbox="roadtrip" data-title="My caption"><img src="<?php echo get_theme_file_uri(); ?>/img/montreal-01.png" alt="imagem motreal" title="Montreal" /> </a>
						</div>
						<div class="item">
							<a href="<?php echo get_theme_file_uri(); ?>/img/montreal-02.png" data-lightbox="roadtrip" data-title="My caption"><img src="<?php echo get_theme_file_uri(); ?>/img/montreal-02.png" alt="imagem motreal" title="Montreal" /> </a>
						</div>
						<div class="item">
							<a href="<?php echo get_theme_file_uri(); ?>/img/montreal-03.png" data-lightbox="roadtrip" data-title="My caption"><img src="<?php echo get_theme_file_uri(); ?>/img/montreal-03.png" alt="imagem motreal" title="Montreal" /> </a>
						</div>
						<div class="item">
							<a href="<?php echo get_theme_file_uri(); ?>/img/montreal-01.png" data-lightbox="roadtrip" data-title="My caption"><img src="<?php echo get_theme_file_uri(); ?>/img/montreal-01.png" alt="imagem motreal" title="Montreal" /> </a>
						</div>
			...
			<div class="row">
				<div class="col-12">
					<div class="owl-carousel cards-slider owl-theme">
						<div class="item">
							<div class="card">
								<img class="card-img-top img-fluid w-100" src="<?php echo get_theme_file_uri(); ?>/img/img-attractions-01.png" alt="Card image cap" title="">
								<div class="card-body">
						...
						<div class="item">
							<div class="card">
								<img class="card-img-top img-fluid w-100" src="<?php echo get_theme_file_uri(); ?>/img/img-attractions-02.png" alt="Card image cap" title="">
								<div class="card-body">
									<span>LOREM IPSUM DOLOR SIT AMET LIRIAM SED DONEC LIRIAM</span>
									<p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
									<div class="line-h-2"></div>
						...
						<div class="item">
							<div class="card">
								<img class="card-img-top img-fluid w-100" src="<?php echo get_theme_file_uri(); ?>/img/img-attractions-03.png" alt="Card image cap" title="">
								<div class="card-body">
									<span>LOREM IPSUM DOLOR SIT AMET LIRIAM SED DONEC LIRIAM</span>
									<p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
									<div class="line-h-2"></div>
						...
						<div class="item">
							<div class="card">
								<img class="card-img-top img-fluid w-100" src="<?php echo get_theme_file_uri(); ?>/img/img-attractions-04.png" alt="Card image cap" title="">
								<div class="card-body">
									<span>LOREM IPSUM DOLOR SIT AMET LIRIAM SED DONEC LIRIAM</span>
									<p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
									<div class="line-h-2"></div>
	...
	<script>
    // GALLERY IMAGES E VIDEOS CARDS SLIDER
    jQuery('.owl-carousel.cards-slider').owlCarousel({
        autoplay: true,
        autoPlaySpeed: 5000,
        autoPlayTimeout: 5000,
        autoplayHoverPause: true,
