                ...
                <div class="carousel-inner" role="listbox">
                    <div class="container-fluid">
                        <div class="row">
                            ...
                            $motivos_terms = wp_get_object_terms( $post->ID,  $taxonomy );
                            if ( !empty( $motivos_terms ) ) {
                                if ( !is_wp_error( $motivos_terms ) ) {
                                    foreach( $motivos_terms as $term ) {
                                        $motivo = $term->name;
                                    }
                                }
                            }
                                        ...
                                        <div class="row">
                                            <div class="col-12 col-lg-8">
                                                <div class="box-caption">
                                                    <div class="box-category"><?php echo $motivo; ?></div>
                                                    <h1><?php the_title(); ?></h1>
                                                    <p><?php the_content(); ?></p>
                                                    <a href="<?php $link_banner = get_post_meta( $post->ID, 'banner_link', true ); echo $link_banner['href']; ?>" class="btn">Veja Mais</a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
